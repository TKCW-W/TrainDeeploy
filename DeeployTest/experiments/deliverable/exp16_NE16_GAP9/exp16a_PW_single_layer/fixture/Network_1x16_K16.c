...
static void _b1_conv1xk_input_0_transpose_tiling_closure(void *_b1_conv1xk_input_0_transpose_tiling_closure_args) {
  ...
  // Transpose [1, 8, 4, 40] -> [1, 4, 40, 8] (Name: b1_conv1xk_input_0_transpose, Op: Transpose)
...
static void _b1_conv1xk_input_0_transpose_closure(void *_b1_conv1xk_input_0_transpose_closure_args) {
  ...
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_input_0_transpose_data_out_ref = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 1280);
  ...
  // NE16 1x16 dense conv as 16 pointwise dispatches (streamin accumulation)
  {
    ne16_task_t task = {
        .data = (ne16_task_data_t){
            ...
            .cfg = (ne16_cfg_t){
                .input_stride = (ne16_stride_t){.d0 = 8, .d1 = 320, .d2 = 0},
...
static void _b1_conv1xk_closure(void *_b1_conv1xk_closure_args) {
  ...
  // CLOSURE FUNCTION CALL
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_data_in_ref = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 10496);
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_weight_ref = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 6400);
...
void RunNetwork(__attribute__((unused)) uint32_t core_id, __attribute__((unused)) uint32_t numThreads) {
  ...
  int32_t *DeeployNetwork_conv_out_tensor;
  {
    ...
    DeeployNetwork_b1_conv1xk_input_0_transposed = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 10496);
...
void InitNetwork(__attribute__((unused)) uint32_t core_id, __attribute__((unused)) uint32_t numThreads) {
  ...
  DeeployNetwork_input_1 = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 6400);
