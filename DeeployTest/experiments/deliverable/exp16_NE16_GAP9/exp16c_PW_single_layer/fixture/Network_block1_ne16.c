...
static PI_L2 int32_t DeeployNetwork_w_pmul_tensor[16] = {304287, 240736, 248163, 204887, 210325, 215079, 270613, 268742,
                                                         256466, 248669, 278279, 276920, 225543, 264806, 299099, 209038};
...
static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_numTiles[2] = {0, 1};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_cumByteOffset[1] = {0};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_cumByteOffset[1] = {0};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_cumByteOffset[1] = {0};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_numTiles[2] = {0, 1};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_cumByteOffset[1] = {0};

static PI_L1 uint8_t DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_cumByteOffset[1] = {0};
...
typedef struct {
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref;
  int32_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref;
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref;
} _b1_wpert_tiling_closure_args_t;

static void _b1_wpert_tiling_closure(void *_b1_wpert_tiling_closure_args) {
  // CLOSURE ARG CAST
  _b1_wpert_tiling_closure_args_t *args = (_b1_wpert_tiling_closure_args_t *)_b1_wpert_tiling_closure_args;

  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref;
  int32_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref;
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref;

  // CLOSURE FUNCTION CALL

  // PerturbRademacher (Name: b1_wpert, Op: RQSPerturbRademacher)
  uint8_t b1_wpert_core_id = (uint8_t)pi_core_id();
  uint8_t b1_wpert_log2Core = (uint8_t)log2(NUM_CORES);

  // Parallelize over the total size of the tensor
  uint32_t b1_wpert_chunk = (2048 >> b1_wpert_log2Core) + ((2048 & (NUM_CORES - 1)) != 0);
  uint32_t b1_wpert_chunk_start = (uint32_t)MIN(b1_wpert_chunk * b1_wpert_core_id, (uint32_t)2048);
  uint32_t b1_wpert_chunk_stop = (uint32_t)MIN(b1_wpert_chunk_start + b1_wpert_chunk, (uint32_t)2048);
  uint32_t b1_wpert_local_size = b1_wpert_chunk_stop - b1_wpert_chunk_start;

  // Calculate the starting channel for this core's chunk of M
  uint32_t b1_wpert_channel_start_offset = b1_wpert_chunk_start % 128;
  ...
  uint32_t chunk_seed = ((42 + perturb_seed_base) + NUM_CORES * 2 + b1_wpert_core_id) ^ (0 * 0x9E3779B1u);
  ...
  float32_t b1_wpert_eps_scale = perturb_eps_use_override ? (perturb_eps_override / perturb_eps_baked) : 1.0f;

  ApplyPerturbQuantRademacher_CHW((const int8_t *)&DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref[b1_wpert_chunk_start],
                                  (int8_t *)&DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref[b1_wpert_chunk_start],
                                  (const int32_t *)DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref, 15, 128, chunk_seed, b1_wpert_local_size,
                                  b1_wpert_chunk_start,
                                  perturbation_sign,   // -- QW: +eps (L+) / -eps (L-)
                                  b1_wpert_eps_scale); // -- QW: zo_update coeff scaling (1.0f = train pass)
...
typedef struct {
  ...
  int32_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref;
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref;
} _b1_wpert_cluster_fork_args_t;

static void _b1_wpert_cluster_fork(void *_b1_wpert_cluster_fork_args) {
  // CLOSURE ARG CAST
  _b1_wpert_cluster_fork_args_t *args = (_b1_wpert_cluster_fork_args_t *)_b1_wpert_cluster_fork_args;
  ...
  // CLOSURE FUNCTION CALL
  _b1_wpert_tiling_closure_args_t DeeployNetwork__b1_wpert_tiling_closure_args =
      (_b1_wpert_tiling_closure_args_t){.DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref,
                                        .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref,
                                        .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref};

  // _b1_wpert_tiling_closure CLOSURE CALL
  _b1_wpert_tiling_closure(&DeeployNetwork__b1_wpert_tiling_closure_args);
...
typedef struct {
  ...
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr;
} _b1_wpert_closure_args_t;

static void _b1_wpert_closure(void *_b1_wpert_closure_args) {
  // CLOSURE ARG CAST
  _b1_wpert_closure_args_t *args = (_b1_wpert_closure_args_t *)_b1_wpert_closure_args;

  int8_t *DeeployNetwork_weight_pert_tensor = args->DeeployNetwork_weight_pert_tensor;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr;

  // CLOSURE FUNCTION CALL
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 0);
  int32_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref = (int32_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 4096);
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 2048);
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_input_1_ref =
      (void *)((char *)DeeployNetwork_input_1 +
               DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_cumByteOffset[*DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr]);
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_w_pmul_tensor_ref =
      (void *)((char *)DeeployNetwork_w_pmul_tensor +
               DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_cumByteOffset[*DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr]);
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_weight_pert_tensor_ref =
      (void *)((char *)DeeployNetwork_weight_pert_tensor +
               DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_cumByteOffset[*DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr]);
  ...
  // TILING LOOP
  for (int TILING_I = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_numTiles[*DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr];
       TILING_I < DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_numTiles[(*DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr) + 1]; TILING_I++) {

    // Transfer input tiles
    channel_input = mchan_channel_alloc();
    mchan_transfer_1d(1443840, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_input_1_ref);
    mchan_transfer_1d(1441856, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_w_pmul_tensor_ref);
    ...
    _b1_wpert_cluster_fork_args_t DeeployNetwork__b1_wpert_cluster_fork_args =
        (_b1_wpert_cluster_fork_args_t){.DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_in_ref,
                                        .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_mul_ref,
                                        .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref};

    pi_cl_team_fork(NUM_CORES, (void *)_b1_wpert_cluster_fork, &DeeployNetwork__b1_wpert_cluster_fork_args);

    // Transfer output tiles
    channel_output = mchan_channel_alloc();
    mchan_transfer_1d(1312768, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_data_out_ref, DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_weight_pert_tensor_ref);
  ...
  *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr += 1;
...
typedef struct {
  int8_t *DeeployNetwork_weight_pert_tensor;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr;
} _b1_wpert_closure_L3_args_t;

static void _b1_wpert_closure_L3(void *_b1_wpert_closure_L3_args) {
  // CLOSURE ARG CAST
  _b1_wpert_closure_L3_args_t *args = (_b1_wpert_closure_L3_args_t *)_b1_wpert_closure_L3_args;

  int8_t *DeeployNetwork_weight_pert_tensor = args->DeeployNetwork_weight_pert_tensor;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr;

  // CLOSURE FUNCTION CALL
  _b1_wpert_closure_args_t DeeployNetwork__b1_wpert_closure_args =
      (_b1_wpert_closure_args_t){.DeeployNetwork_weight_pert_tensor = DeeployNetwork_weight_pert_tensor,
                                 .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr};

  // _b1_wpert_closure CLOSURE CALL
  _b1_wpert_closure(&DeeployNetwork__b1_wpert_closure_args);

  // CLOSURE ARG WRITEBACK
}

typedef struct {
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref;
} _b1_wenc_tiling_closure_args_t;

static void _b1_wenc_tiling_closure(void *_b1_wenc_tiling_closure_args) {
  // CLOSURE ARG CAST
  _b1_wenc_tiling_closure_args_t *args = (_b1_wenc_tiling_closure_args_t *)_b1_wenc_tiling_closure_args;

  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref;

  // CLOSURE FUNCTION CALL

  // NE16WeightEncode (Name: b1_wenc, Op: NE16WeightEncode) -- bit-serial encode on the cluster -- QW
  {
    uint32_t b1_wenc_nrows = 256;
    uint32_t b1_wenc_chunk = (b1_wenc_nrows + NUM_CORES - 1) / NUM_CORES;
    uint32_t b1_wenc_start = MIN(b1_wenc_chunk * (uint32_t)pi_core_id(), b1_wenc_nrows);
    uint32_t b1_wenc_stop = MIN(b1_wenc_start + b1_wenc_chunk, b1_wenc_nrows);

    NE16WeightEncode_i8_u8((const int8_t *)DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref,
                           (uint8_t *)DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref, 16, 8, 16, b1_wenc_start, b1_wenc_stop - b1_wenc_start);
  }
...
typedef struct {
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref;
} _b1_wenc_cluster_fork_args_t;

static void _b1_wenc_cluster_fork(void *_b1_wenc_cluster_fork_args) {
  // CLOSURE ARG CAST
  _b1_wenc_cluster_fork_args_t *args = (_b1_wenc_cluster_fork_args_t *)_b1_wenc_cluster_fork_args;

  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref;

  // CLOSURE FUNCTION CALL
  _b1_wenc_tiling_closure_args_t DeeployNetwork__b1_wenc_tiling_closure_args =
      (_b1_wenc_tiling_closure_args_t){.DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref,
                                       .DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref};

  // _b1_wenc_tiling_closure CLOSURE CALL
  _b1_wenc_tiling_closure(&DeeployNetwork__b1_wenc_tiling_closure_args);
...
typedef struct {
  ...
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr;
} _b1_wenc_closure_args_t;

static void _b1_wenc_closure(void *_b1_wenc_closure_args) {
  // CLOSURE ARG CAST
  _b1_wenc_closure_args_t *args = (_b1_wenc_closure_args_t *)_b1_wenc_closure_args;

  int8_t *DeeployNetwork_weight_pert_tensor = args->DeeployNetwork_weight_pert_tensor;
  uint8_t *DeeployNetwork_weight_enc_tensor = args->DeeployNetwork_weight_enc_tensor;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr = args->DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr;

  // CLOSURE FUNCTION CALL
  int8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 4096);
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L1 + 0);
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_weight_pert_tensor_ref =
      (void *)((char *)DeeployNetwork_weight_pert_tensor +
               DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_cumByteOffset[*DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr]);
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_weight_enc_tensor_ref =
      (void *)((char *)DeeployNetwork_weight_enc_tensor +
               DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_cumByteOffset[*DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr]);
  ...
  // TILING LOOP
  for (int TILING_I = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_numTiles[*DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr];
       TILING_I < DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_numTiles[(*DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr) + 1]; TILING_I++) {

    // Transfer input tiles
    channel_input = mchan_channel_alloc();
    mchan_transfer_1d(1443840, DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref, DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_weight_pert_tensor_ref);
    ...
    _b1_wenc_cluster_fork_args_t DeeployNetwork__b1_wenc_cluster_fork_args =
        (_b1_wenc_cluster_fork_args_t){.DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_in_ref,
                                       .DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref};

    pi_cl_team_fork(NUM_CORES, (void *)_b1_wenc_cluster_fork, &DeeployNetwork__b1_wenc_cluster_fork_args);

    // Transfer output tiles
    channel_output = mchan_channel_alloc();
    mchan_transfer_1d(1314816, DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_data_out_ref, DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_weight_enc_tensor_ref);
  ...
  *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr += 1;
...
typedef struct {
  ...
  uint8_t *DeeployNetwork_weight_enc_tensor;
  uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr;
} _b1_wenc_closure_L3_args_t;

static void _b1_wenc_closure_L3(void *_b1_wenc_closure_L3_args) {
  // CLOSURE ARG CAST
  _b1_wenc_closure_L3_args_t *args = (_b1_wenc_closure_L3_args_t *)_b1_wenc_closure_L3_args;
  ...
  // CLOSURE FUNCTION CALL
  _b1_wenc_closure_args_t DeeployNetwork__b1_wenc_closure_args =
      (_b1_wenc_closure_args_t){.DeeployNetwork_weight_pert_tensor = DeeployNetwork_weight_pert_tensor,
                                .DeeployNetwork_weight_enc_tensor = DeeployNetwork_weight_enc_tensor,
                                .DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr};

  // _b1_wenc_closure CLOSURE CALL
  _b1_wenc_closure(&DeeployNetwork__b1_wenc_closure_args);
...
static void _b1_conv1xk_closure(void *_b1_conv1xk_closure_args) {
  ...
  void *DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_weight_enc_tensor_ref =
      (void *)((char *)DeeployNetwork_weight_enc_tensor +
  ...
  for (int TILING_I = DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_numTiles[*DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_tileIdxPtr];
...

    {
      mchan_transfer_t __mchan_tmp = {.cmd = 1445888,
                                      ...
                                      .ext = DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_weight_enc_tensor_ref};
...
static void _b1_conv1xk_closure_L3(void *_b1_conv1xk_closure_L3_args) {
  ...
  _b1_conv1xk_closure_args_t DeeployNetwork__b1_conv1xk_closure_args =
      (_b1_conv1xk_closure_args_t){.DeeployNetwork_weight_enc_tensor = DeeployNetwork_weight_enc_tensor,
...
void RunNetwork(__attribute__((unused)) uint32_t core_id, __attribute__((unused)) uint32_t numThreads) {
  ...
  int32_t *DeeployNetwork_conv_out_tensor;
  {
    ...
    uint8_t bu_DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = 0;
    uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = &bu_DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr;
    DeeployNetwork_weight_pert_tensor = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 15632);
    _b1_wpert_closure_L3_args_t DeeployNetwork__b1_wpert_closure_L3_args =
        (_b1_wpert_closure_L3_args_t){.DeeployNetwork_weight_pert_tensor = DeeployNetwork_weight_pert_tensor,
                                      .DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr = DeeployNetwork_TILING_CODEGEN_L1_b1_wpert_tileIdxPtr};

    // _b1_wpert_closure_L3 CLOSURE CALL
    _b1_wpert_closure_L3(&DeeployNetwork__b1_wpert_closure_L3_args);
  }
  {

    uint8_t bu_DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr = 0;
    uint8_t *DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr = &bu_DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr;
    DeeployNetwork_weight_enc_tensor = (uint8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 11536);
    _b1_wenc_closure_L3_args_t DeeployNetwork__b1_wenc_closure_L3_args =
        (_b1_wenc_closure_L3_args_t){.DeeployNetwork_weight_pert_tensor = DeeployNetwork_weight_pert_tensor,
                                     .DeeployNetwork_weight_enc_tensor = DeeployNetwork_weight_enc_tensor,
                                     .DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr = DeeployNetwork_TILING_CODEGEN_L1_b1_wenc_tileIdxPtr};

    // _b1_wenc_closure_L3 CLOSURE CALL
    _b1_wenc_closure_L3(&DeeployNetwork__b1_wenc_closure_L3_args);
  }
  {
    ...
    DeeployNetwork_conv_out_tensor = (int32_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 19712);
    _b1_conv1xk_closure_L3_args_t DeeployNetwork__b1_conv1xk_closure_L3_args =
        (_b1_conv1xk_closure_L3_args_t){.DeeployNetwork_weight_enc_tensor = DeeployNetwork_weight_enc_tensor,
                                        .DeeployNetwork_conv_out_tensor = DeeployNetwork_conv_out_tensor,
                                        .DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_tileIdxPtr = DeeployNetwork_TILING_CODEGEN_L1_b1_conv1xk_tileIdxPtr};
...
void InitNetwork(__attribute__((unused)) uint32_t core_id, __attribute__((unused)) uint32_t numThreads) {
  ...
  DeeployNetwork_input_1 = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 11536);
