...
"""exp19 step 1 (fresh calibration on the artifacts_reference base weights): (a) regenerate pooled@99.99 activation thresholds
...
json.dump(thresholds, open(HERE / "fixture/pooled_9999_fold3_ref.json", "w"), indent=1)
